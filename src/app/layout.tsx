    ...
    <html lang="en">
      ...
      <body className={`${cinzel.variable} ${rajdhani.variable} antialiased`}>
        ...
        <noscript>
          ...
          >
            <h1 style={{ color: "#e8a54b", marginBottom: 16 }}>
              The Forge — Robert Blaylock
            </h1>
            <p style={{ marginBottom: 8 }}>
              Senior Full Stack Developer &amp; 3D Software Engineer
            </p>
            <p style={{ color: "#6a5a4a", fontSize: 14 }}>
              This interactive 3D portfolio requires JavaScript to run.
              Please enable JavaScript to explore The Forge.
            </p>
          </div>
        </noscript>
      </body>
